      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-navy-400 text-sm leading-relaxed mb-4">
              From YouTube to Done — in seconds.
            </p>
            <p className="text-navy-400 text-xs">
              © 2025 TubeScribed. All rights reserved.
            </p>
          </div>

          {/* Product */}
          <div>
            <h4 className="font-syne font-semibold text-navy-100 mb-4 text-sm tracking-wide uppercase">
              Product
            </h4>
              ...
              {FOOTER_LINKS.product.map((link) => (
                <li key={link.href}>
                  {link.href.startsWith("http") ? (
                    <a
                      href={link.href}
                      className="text-navy-400 hover:text-navy-100 text-sm transition-colors duration-200"
                    >
                      {link.label}
                    </a>
                  ) : (
        ...
        <div className="border-t border-navy-700 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-6">
            <a
              href="/privacy"
              className="text-navy-400 hover:text-navy-100 text-xs transition-colors duration-200"
            >
              Privacy Policy
            </a>
            <a
