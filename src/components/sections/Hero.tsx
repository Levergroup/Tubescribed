  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-navy-900 grid-pattern">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 40% at 50% 0%, rgba(255,59,48,0.08) 0%, transparent 70%)",
        }}
      />
      ...
      <div className="relative z-10 max-w-[900px] mx-auto px-4 sm:px-6 py-32 text-center">
        ...
        <motion.h1
          ...
          className="font-syne font-bold text-5xl lg:text-7xl text-navy-100 leading-[1.1] mb-6"
        >
        ...
        <motion.p
          ...
          className="font-dm-sans text-xl text-navy-400 max-w-2xl mx-auto leading-relaxed mb-10"
        >
          Paste a YouTube link. Get a clean transcript, branded SOP, blog post,
          email sequence, and more — in seconds. No VA. No manual editing. Just
          done.
        </motion.p>
        ...
        >
          3 free transcripts/month. Upgrade anytime.
        </motion.p>

        {/* Hero Visual — URL Input Mock */}
        <motion.div
          variants={fadeUp}
          initial="initial"
          animate="animate"
        ...
        >
          <div className="bg-navy-800 border border-navy-700 rounded-2xl p-6 shadow-[0_8px_40px_rgba(0,0,0,0.3)]">
            ...
            <div className="flex items-center gap-3 bg-navy-900 border border-navy-700 rounded-xl p-4 mb-4">
              <span className="text-navy-400 text-sm flex-1 truncate font-dm-sans">
                https://youtube.com/watch?v=dQw4w9WgXcQ
              </span>
              <motion.button
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="btn-gradient text-white text-sm font-semibold px-4 py-2 rounded-lg shrink-0"
              >
                Transcribe
              </motion.button>
            </div>
