...
const steps = [
  {
    ...
    description:
      "No downloads. No browser extensions. Just copy the URL and paste it into TubeScribed. Works with any public YouTube video — tutorials, podcasts, interviews, coaching calls.",
  },
  {
    number: "02",
    icon: Sparkles,
    title: "AI Cleans & Structures It",
    description:
      "Claude AI removes filler words, adds punctuation, and formats the transcript into clean, readable sections with timestamps — publication-ready in seconds.",
  },
  {
    number: "03",
    icon: Download,
    title: "Get Your Branded Assets",
    description:
      "Choose from 15 output types: SOPs, blog posts, email sequences, social content, and more — all written in your brand voice automatically.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          <div className="hidden lg:flex absolute top-1/2 -translate-y-1/2 left-0 right-0 pointer-events-none">
            <div className="w-1/3" />
            <div className="w-1/12 flex items-center justify-center text-navy-700 text-2xl font-bold">
              →
            </div>
            <div className="w-1/3" />
            <div className="w-1/12 flex items-center justify-center text-navy-700 text-2xl font-bold">
