    ...
    <section className="py-24 lg:py-32 bg-navy-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.h2
          ...
          className="font-syne font-bold text-3xl lg:text-5xl text-navy-100 text-center mb-4"
        >
        ...
        <motion.p
          ...
          className="text-center text-navy-400 text-base font-dm-sans mb-16 max-w-lg mx-auto"
        >
          One transcript pays for the entire month at any professional hourly rate.
        </motion.p>
          ...
          {PLANS.map((plan, index) => (
            <motion.div
              ...
              className={`relative rounded-2xl p-8 flex flex-col ${
                plan.popular
                  ? "bg-navy-900 scale-105 shadow-[0_8px_40px_rgba(255,59,48,0.2)]"
            ...
            >
              ...
              <div className="mb-6">
                <h3 className="font-syne font-bold text-xl text-navy-100 mb-1">
                  {plan.name}
                </h3>
                <p className="text-navy-400 text-sm font-dm-sans mb-4">
                  {plan.subtitle}
                </p>
                <div className="flex items-baseline gap-1">
                  <span className="font-syne font-bold text-4xl text-navy-100">
                    {plan.price}
                  </span>
        ...
        <motion.p
          ...
          className="text-center text-navy-400 text-sm font-dm-sans"
        >
          Need more? Credit packs available.{" "}
          <Link
            href="/pricing"
            className="text-navy-100 hover:text-brand-red underline underline-offset-2 transition-colors duration-200"
          >
            See all pricing →
          </Link>
        </motion.p>
