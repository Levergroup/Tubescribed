  ...
  return (
    <section className="py-24 lg:py-32 bg-navy-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          Every tool your content workflow needs
        </motion.h2>
          ...
          {FEATURES.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className="bg-navy-900 border border-navy-700 rounded-2xl p-6 lg:p-8 hover:border-brand-red transition-colors duration-300 group"
              >
                ...
                <h3 className="font-syne font-semibold text-lg text-navy-100 mb-2">
                  {feature.title}
                </h3>
