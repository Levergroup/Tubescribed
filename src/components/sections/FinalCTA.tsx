    ...
    <section className="py-24 lg:py-32 bg-navy-900">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="relative bg-navy-800 rounded-3xl p-12 lg:p-16 text-center"
          style={{
            background:
        ...
        >
          ...
          {/* Headline */}
          <h2 className="font-syne font-bold text-4xl lg:text-6xl text-navy-100 leading-tight mb-6">
            Your next video is already
            <br />
            <GradientText>a blog post.</GradientText> You just
            <br />
            haven&apos;t clicked yet.
          </h2>
          ...
          <p className="font-dm-sans text-navy-400 text-lg max-w-xl mx-auto mb-10 leading-relaxed">
            Join thousands of creators, agencies, and coaches who stopped
            wasting content and started building systems.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
            ...
            >
              Start Free — 3 Transcripts/Month
            </Button>
