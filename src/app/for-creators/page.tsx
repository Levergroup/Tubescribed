      ...
      <section className="py-24 lg:py-32 bg-navy-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <GradientText>Start Using It.</GradientText>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Every video you post is a blog post, email, and SOP waiting to
            happen. TubeScribed unlocks all of it in 8 seconds.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="font-syne font-bold text-3xl lg:text-4xl text-navy-100 mb-4">
              With TubeScribed, Marcus publishes{" "}
              <GradientText>3x more</GradientText> without making more videos.
            </h2>
            <p className="font-dm-sans text-navy-400 text-base">
              Marcus is a 32-year-old YouTube creator and course builder. Here&apos;s what changed.
            </p>
          </motion.div>
          <div className="space-y-4">
            {outcomes.map((outcome, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className="flex items-start gap-4 bg-navy-800 border border-navy-700 rounded-2xl p-6 hover:border-brand-red transition-colors duration-300"
              >
                <CheckCircle2
                  size={20}
      ...
      <section className="py-24 bg-navy-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.h2
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="font-syne font-bold text-3xl text-navy-100 mb-6"
          >
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6, delay: 0.1 }}
            className="font-dm-sans text-navy-400 text-lg leading-relaxed max-w-2xl mx-auto mb-10"
          >
            You already do the hard part — you create great content. TubeScribed handles
            the repurposing. Paste a URL from any of your videos and get a clean
            transcript plus 15 content formats in seconds. No VA. No editing.
            No extra hours.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
