    ...
    <div className="min-h-screen bg-navy-900">
      ...
      <section className="py-24 lg:py-32 bg-navy-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Your Methodology Deserves{" "}
            <GradientText>to Be Documented.</GradientText>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Train TubeScribed on your brand voice once. Every SOP it generates
            sounds exactly like you — your words, your framework, your
            methodology.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
      ...
      <section className="py-24 bg-navy-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            The undocumented methodology problem
          </motion.h2>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="w-16 h-16 rounded-2xl bg-navy-900 border border-navy-700 flex items-center justify-center mx-auto mb-6">
              <ClipboardList size={32} className="text-brand-red" />
            </div>
            <h2 className="font-syne font-bold text-3xl text-navy-100 mb-4">
              The SOP Generator for Coaches
            </h2>
            <p className="font-dm-sans text-navy-400 text-lg leading-relaxed max-w-2xl mx-auto mb-6">
              Here&apos;s how it works: record a coaching call, training session, or
              YouTube video explaining your framework. Paste the URL into
              TubeScribed. In seconds, you get a clean transcript — and with one
              click, a structured SOP in your voice.
            </p>
            <p className="font-dm-sans text-navy-400 text-base leading-relaxed max-w-xl mx-auto mb-6">
              The SOP includes your step-by-step process, key terminology,
              client action items, and your brand language — all automatically
              formatted and ready to send. No more rewriting the same thing
              from scratch. No more explaining verbally what should be written
              down.
            </p>
            <p className="font-dm-sans text-navy-100 text-base font-medium">
              It&apos;s your methodology. Documented. Finally.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="font-syne font-bold text-3xl lg:text-4xl text-navy-100 mb-4">
              What coaches build with TubeScribed
            </h2>
            <p className="font-dm-sans text-navy-400 text-base">
              David is a 45-year-old business coach. Here&apos;s what changed when he started using TubeScribed.
            </p>
          </motion.div>
